    ...
    pub fn hit(&self, ray: &Ray, transform: &Matrix4<f32>) -> bool {
        ...
        for i in 0..6 {
            let (p, n) = match i {
                ...
                1 => {
                    // Back face
                    let p = Vector4::new(self.lower_point.x, self.lower_point.y, self.upper_point.y, 1.0);
                    let n = Vector4::new(0.0, 0.0, 1.0, 0.0);
                    (p, n)
                },
                2 => {
                ...
                3 => {
                    // Right face
                    let p = Vector4::new(self.upper_point.x, self.lower_point.y, self.lower_point.z, 1.0);
                    let n = Vector4::new(1.0, 0.0, 0.0, 0.0);
                    (p, n)
                },
                4 => {
                ...
                5 => {
                    // Top face
                    let p = Vector4::new(self.lower_point.x, self.upper_point.y, self.lower_point.z, 1.0);
                    let n = Vector4::new(0.0, 1.0, 0.0, 0.0);
                    (p, n)
                },
                _ => panic!("Unreachable!"),
